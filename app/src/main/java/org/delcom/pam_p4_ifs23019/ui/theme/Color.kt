package org.delcom.pam_p4_ifs23019.ui.theme
...
/* =========================
   ...
   ========================= */
val DessertGreen = Color(0xFF2E7D32)      // Hijau natural untuk tanaman
val DessertGreenLight = Color(0xFF4CAF50)  // Hijau lebih terang
val DessertGreenDark = Color(0xFF1B5E20)   // Hijau lebih gelap
val DessertAccent = Color(0xFF8BC34A)      // Hijau cerah sebagai aksen

val DelcomYellow = Color(0xFFFFC107)
val DelcomYellowSoft = Color(0xFFFFE082)
/* =========================
   LIGHT THEME (Dessert THEME)
   ========================= */
val md_theme_light_primary = DessertGreen
...
val md_theme_light_tertiary = DessertGreenDark
...
val md_theme_light_inversePrimary = DessertGreenDark
val md_theme_light_shadow = Color.Black
val md_theme_light_surfaceTint = DessertGreen

/* =========================
   DARK THEME (Dessert THEME)
   ========================= */
val md_theme_dark_primary = DessertGreenLight
...
val md_theme_dark_tertiary = DessertAccent
...
val md_theme_dark_inversePrimary = DessertGreen
val md_theme_dark_shadow = Color.Black
val md_theme_dark_surfaceTint = DessertGreenLight